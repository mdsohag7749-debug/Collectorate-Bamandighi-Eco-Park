...
const translations = {
  bn: {
    ...
    'hero-title':    'কালেক্টরেট<br/><span class="gradient-text">বামনডিহি ইকো পার্ক</span>',
    ...
    'about-p1':    'রংপুর জেলার তারাগঞ্জ উপজেলার ইকরচালী ইউনিয়নে রংপুর-সৈয়দপুর মহাসড়কের পাশে অবস্থিত কালেক্টরেট বামনডিহি ইকো পার্ক। একসময় এই স্থানটি জঙ্গল ও ময়লা-আবর্জনায় ভরা ছিল। ২০২০ সালে জেলা প্রশাসক ও উপজেলা নির্বাহী কর্মকর্তার উদ্যোগে ১৮ লাখ টাকা ব্যয়ে দিঘিটি পুনঃখনন করে একটি দৃষ্টিনন্দন ইকো পার্কে রূপান্তর করা হয়।',
    ...
    'attr-desc':   'বামনডিহি ইকো পার্কে রয়েছে অসংখ্য আকর্ষণীয় স্থান ও কার্যক্রম',
    'attr1-title': 'ঐতিহাসিক বামনদীঘি', 'attr1-desc': 'পার্কের কেন্দ্রবিন্দু এই বিশাল দিঘি। টাইলস বাঁধানো হাঁটার পথ দিঘির চারপাশ ঘিরে রয়েছে। স্বচ্ছ জলে আকাশের প্রতিফলন অপূর্ব দৃশ্য তৈরি করে।',
    ...
    /* Footer */
    'footer-copy':   '© ২০২৬ কালেক্টরেট বামনডিহি ইকো পার্ক। সর্বস্বত্ব সংরক্ষিত।',
